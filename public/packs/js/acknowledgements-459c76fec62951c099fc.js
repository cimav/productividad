...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/acknowledgements.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/acknowledgements.js":
/*!**************************************************!*\
  !*** ./app/javascript/packs/acknowledgements.js ***!
  \**************************************************/
/*! no exports provided */
...
$(document).on('change', '.acknowledgement-type-select', function () {
  ...
  var url = '/acknowledgements/select/' + type_id;
...
$(document).on('click', '.acknowledgement-add', function () {
  ...
  $.post("/agradecimientos/agrega", {
    ...
    $.get(url, function (data) {
      $('#product-acknowledgements-ui').html(data);
      $('#acknowledgement_author_is').hide();
    });
    _vizuaalog_bulmajs__WEBPACK_IMPORTED_MODULE_0__["default"].create('notification', {
      isDismissable: true,
...
/******/ });
//# sourceMappingURL=acknowledgements-459c76fec62951c099fc.js.map