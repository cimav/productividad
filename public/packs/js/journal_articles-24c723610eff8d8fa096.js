...
/* WEBPACK VAR INJECTION */(function($) {var start_journal_articles = function start_journal_articles() {
...
$(document).ready(start_journal_articles);
$(document).on('page:load', start_journal_articles);
$(document).on('turbolinks:load', start_journal_articles);
...
/******/ });
//# sourceMappingURL=journal_articles-24c723610eff8d8fa096.js.map