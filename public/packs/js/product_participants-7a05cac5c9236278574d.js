...
$(document).on('change', '#participant_type_new', function () {
  if ($(this).val() == 9999) {
    // External
    $('#select_person_new').css("display: none;");
    $('#participant_author_is').css("display: block;");
  } else {
    // From organization
    $('#select_person_new').css("display: block;");
    $('#participant_author_is').css("display: none;");
  }
});
...
/******/ });
//# sourceMappingURL=product_participants-7a05cac5c9236278574d.js.map