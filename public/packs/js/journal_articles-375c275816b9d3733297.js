...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('change', '#journal_article_status', function () {
  v = $(this).val();

  if (v == 1) {
    // SENT
    $('.accepted-status').hide(500);
    $('.published-status').hide(500);
  } else if (v == 2) {
    // ACCEPTED
    $('.accepted-status').show(500);
    $('.published-status').hide(500);
  } else if (v == 3) {
    // PUBLISHED
    $('.accepted-status').show(500);
    $('.published-status').show(500);
  } else if (v == 4) {// REJECTED
  }
});
...
/******/ });
//# sourceMappingURL=journal_articles-375c275816b9d3733297.js.map