...
/* WEBPACK VAR INJECTION */(function($) {$(document).on('change', '.participant-select', function () {
  ...
  $.post("/participantes/actualiza", {
    ...
    $('#participant-notification').show(500);
  });
});
...
/******/ });
//# sourceMappingURL=product_participants-288e59df89627e280a11.js.map