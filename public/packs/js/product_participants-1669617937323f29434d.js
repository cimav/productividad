...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _vizuaalog_bulmajs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @vizuaalog/bulmajs */ "./node_modules/@vizuaalog/bulmajs/src/bulma.js");
!(function webpackMissingModule() { var e = new Error("Cannot find module '@vizuaalog/bulmajs/src/plugins/Modal'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());


$(document).on('change', '.participant-select', function () {
  var participant_id = $(this).data('participant-id');
  var participant_type = $('#participant_type_' + participant_id).val();
  var person_id = $('#person_id_' + participant_id).val();
  var participation = $('#participation_' + participant_id).val();
  $.post("/participantes/actualiza", {
    id: participant_id,
    person_id: person_id,
    participant_type: participant_type,
    participation: participation
  }).done(function (data) {
    // $('#participant-notification-msg').html('Participante actualizado');
    // $('#participant-notification').show();
    var modal = !(function webpackMissingModule() { var e = new Error("Cannot find module '@vizuaalog/bulmajs/src/plugins/Modal'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).create({
...
/******/ });
//# sourceMappingURL=product_participants-1669617937323f29434d.js.map