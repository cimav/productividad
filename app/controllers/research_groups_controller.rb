class ResearchGroupsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @research_group.save
        format.html { redirect_to research_groups_url, notice: 'Grupo creado.' }
  ...
  def update
    respond_to do |format|
      if @research_group.update(research_group_params)
        format.html { redirect_to research_groups_url, notice: 'Grupo actualizado.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to research_groups_url, notice: 'Grupo eliminado.' }
  ...
  private
    ...
    def research_group_params
      params.require(:research_group).permit(:name, :description, :department_id)
    end
end
